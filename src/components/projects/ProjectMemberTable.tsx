      ...
      <Table>
        ...
        <TableBody>
          {members.map((member) => (
            <TableRow
              key={member.id}
              className={!member.isActive ? "opacity-60 bg-gray-50" : ""}
            >
              {/* User Info */}
              <TableCell className="flex items-center gap-3">
                <Avatar className="h-9 w-9">
                  <AvatarFallback
                    className={
                      member.isActive ? "bg-primary/10 text-primary" : ""
                    }
                  >
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  setEditForm({ ...editForm, chargeRate: e.target.value })
                }
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  setEditForm({ ...editForm, payoutRate: e.target.value })
                }
                className="col-span-3"
              />
            </div>
